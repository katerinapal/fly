                                    ...
                                    _this.p = new Promise(function (resolve) {
                                            ...
                                            if (interceptor.p) {
                                                if (isResponseInterceptor) {
                                                    ...
                                                    (async () => {
                                                        ...
                                                        generatedVariable1 = await interceptor.p;
                                        ...
                                        (async () => {
                                            ...
                                            try {
                                                ...
                                                return await t(generatedVariable1);
                                            }
                                ...
                                function enqueueIfLocked(promise, callback) {
                                    if (promise) {
                                        (async () => {
                                            ...
                                            generatedVariable2 = await promise;
...
var qs = __webpack_require__(5);
        ...
        (async () => {
            try {
                const d = await _index2.default.get("../package.json", {aa: 8, bb: 9, tt: {xx: 5}});
        ...
        (async () => {
            try {
                const d = await _index2.default.post("../package.json", {aa: 8, bb: 9, tt: {xx: 5}});
        ...
        (async () => {
            const d = await _index2.default.request("../package.json", {hh: 5}, {
        method: "post"
    });
...
//send data in the application/x-www-form-urlencoded format
        (async () => {
            const d = await _index2.default.get("", qs.stringify({aa: 8, bb: 9, tt: {xx: 5}}));

            return await (async d => {
            })(d);
        })();
        (async () => {
            const d = await _index2.default.post("../package.json", qs.stringify({aa: 8, bb: 9, tt: {xx: 5}}));
